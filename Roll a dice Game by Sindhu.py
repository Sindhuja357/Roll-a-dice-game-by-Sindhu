...
def main():
    ...
    while current_turn <= max_turns:
        ...
        has_lucky_charm = get_yes_no_input("Do you want to use your lucky charm? (yes/no): ")
        ...
        if dice_result == 1:
            ...
            double_or_nothing = get_yes_no_input("Do you want to go double or nothing? (yes/no): ")
        ...
        if current_turn < max_turns:
            shop_choice = get_yes_no_input("Do you want to visit the shop? (yes/no): ")
            if shop_choice == 'yes':
